(function($) {	
   ...
   //7.Gallery masonary style
	...
	function selectDropdown() {
		...
		$("#concat-top-close").bind('click',function(){
			$("#concat-section").html("<div id='concat-close-html'>"
				+"<a id='concat-close-html-lx'>联系我们</a><a id='concat-close-html-show'>口</a></div>");
				$("#concat-close-html-show").bind('click',function(){
					$("#concat-section").html("<div id='concat'>"
							+"<div id='concat-top'>"
								+"<a id='concat-top-lx'>联系我们</a><a id='concat-top-close'>-</a>"
							+"</div>"
							+"<div id='concat-body'>"
								+"<form>"
									...
									+"</div>"
									+"<input type='submit' id='submit'  value='立即发送' />"
								+"</form>"
							+"</div>"
						+"</div>");
				})
	...
	$("#submit").on('click',function(){
		var text = document.getElementById("concat-text").value;
		var phone = document.getElementById("concat-phone").value;
		var name = document.getElementById("concat-name").value;
		var address = document.getElementById("concat-address").value;
		if(phone==""){
			alert("请输入号码");
		}else{
	...
	//$("#concat-top-close").on('click',concat_close());
	//$("#concat-close-html-show").on('click',concat_show());
